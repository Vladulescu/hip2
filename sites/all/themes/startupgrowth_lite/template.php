...
function startupgrowth_lite_preprocess_html(&$variables) {
	...
	drupal_add_css(path_to_theme() . '/demo.css', array('group' => CSS_THEME, 'type' => 'file'));
	drupal_add_css(path_to_theme() . '/details-shim.min.css', array('group' => CSS_THEME, 'type' => 'file'));
	...
	*/
	 ...
	 */
			drupal_add_js(path_to_theme() .'/js/xtk_edge.js');
		drupal_add_js(path_to_theme() .'/js/xtk_xdat.gui.js');
		drupal_add_js(path_to_theme() .'/js/leap.min.js');
		drupal_add_js(path_to_theme() .'/js/details-shim.min.js');
		drupal_add_js(path_to_theme() .'/js/demo.js');
